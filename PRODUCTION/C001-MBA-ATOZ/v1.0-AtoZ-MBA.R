...
##  11-Dec-17   Complete output 1st version of images for all categories.
##
##############################################################################################################
...
plot(t_rules, method='graph', control=list(verbose=F, main=""))
dev.copy(device=png, filename="t_rules.png", width=1000, height=800)
dev.off()

plot(pa_rules, method='graph', control=list(verbose=F, main=""))
dev.copy(device=png, filename="pa_rules.png", width=1000, height=800)
dev.off()

plot(p_rules, method='graph', control=list(verbose=F, main=""))
dev.copy(device=png, filename="p_rules.png", width=1000, height=800)
dev.off()

plot(oe_rules, method='graph', control=list(verbose=F, main=""))
dev.copy(device=png, filename="oe_rules.png", width=1000, height=800)
dev.off()

plot(s_rules, method='graph', control=list(verbose=F, main=""))
dev.copy(device=png, filename="s_rules.png", width=1000, height=800)
dev.off()

plot(tech_rules, method='graph', control=list(verbose=F, main=""))
dev.copy(device=png, filename="tech_rules.png", width=1000, height=800)
dev.off()

plot(c_rules, method='graph', control=list(verbose=F, main=""))
dev.copy(device=png, filename="c_rules.png", width=1000, height=800)
dev.off()
