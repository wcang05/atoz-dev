...
## Version: 1.0
##
## up-sale.py - Generate data for calculating cross-sale dashboard.
## 
##
## Usage Example:
## python up-sale.py 31122017-extract_orders.csv ALL all_cust_bhv_lod_aa.csv
##
## Version History:
...
if (len(sys.argv) < 2):
    print ">> Usage: up-sale <sale-data-source_csv> <output_list_csv>"
    print ">> Type 'up-sale help' to understand the program usage."

else:
    if (sys.argv[1]=='help'):
        ## Displaying the program help content.
        print ">> Generate the up-sale dashboard data by analyzing the sale data ..."        
        print ">> Usage: up-sale <sale-data-source_csv> <output_list_csv>"
