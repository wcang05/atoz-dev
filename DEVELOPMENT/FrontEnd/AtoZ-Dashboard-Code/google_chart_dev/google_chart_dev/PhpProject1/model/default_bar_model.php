...
class default_bar_parameters {  
    
    // For bar Chart
    // Generate an array of years, from earliest until latest
    static function list_year_bar_chart(){
    ...
    static function latest_year_bar_chart(){
    ...
    static function largest_segment_bar_chart(){  
...
class default_bar_charts{
    
    static function default_bar_chart(){
    ...
    static function default_bar_chart_table(){
        // Draw table (largest area and latest year)
        $default_bar_table_query = "SELECT sample_data.Firtname, 
